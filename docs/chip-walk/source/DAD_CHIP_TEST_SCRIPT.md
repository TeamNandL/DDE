# Chip tonight: three paste tests

Use these in order. Paste each block as one message into Chip. For test 3, wait for Chip's reply to test 2 before pasting it. These are dad-facing proofs: Chip should stay short, use one idea at a time, and never expose plumbing, tokens, URLs, or raw PII.

## 1) Cancelled-visit vent — notice path
...
**Pass when Chip replies:**

- One plain noticed sentence, such as “They cancelled your Friday visit.”
- Then exactly: **“Matter to you?”** (or the same short question in Chip’s voice).
- No “got it,” receipt language, menu, legal advice, or invented facts.

## 2) Hot co-parent vent — cold draft path
...
- The hot vent is routed to one calm, factual cold draft.
- Chip gives exactly one **Next**—not a menu or a stack of tasks.
