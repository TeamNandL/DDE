...
import { SCHEMA_PATH, FTS_SCHEMA_PATH, NOTICED_SCHEMA_PATH, RETURN_SCHEMA_PATH } from "./schema.js";
...
process.stdout.write(
  `applied ${SCHEMA_PATH} + ${FTS_SCHEMA_PATH} + ${NOTICED_SCHEMA_PATH} + ${RETURN_SCHEMA_PATH} (RLS plan not applied)\n`,
);
